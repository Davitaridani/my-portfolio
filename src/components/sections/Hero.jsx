				...
				<div className="md:flex items-center justify-between sm:flex-col md:flex-row">
					...
					<div className="w-full md:basis-1/2">
						...
						<div className="flex items-center gap-6 mt-7">
							<a href="davitaridani@gmail.com" ><span className='flex items-center bg-primaryColor text-white font-medium gap-1 hover:bg-smallTextColor ease-in duration-300 py-2 px-4 rounded-[8px]'><HiOutlineMail /> Hire Me</span>
							</a>
						...
						<p className='flex gap-1 text-headingColor font-medium mt-12 text-[15px] leading-7 sm:pl-14 sm:pr-10'>
							...
							I can help you for build your web application and design your project. So, let's talk!
						</p>
						<div className="flex items-center gap-4 mt-14">
							...
							{iconHero.map((item, index) => (
								<span className='border-solid border-2 border-primaryColor flex items-center justify-center h-[30px] w-[30px] rounded-full hover:bg-primaryColor duration-300 ease-in cursor-pointer group' key={index}>
									<a href="#" className="text-smallTextColor duration-300 ease-in group-hover:text-white text-base font-semibold ">{item}</a>
								</span>
							))}
						</div>
					</div>
