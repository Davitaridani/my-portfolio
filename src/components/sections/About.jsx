			...
			<div className="container overflow-hidden">
				...
				<div className="flex">
					<div className="w-full basis-1/2">
						<h3 className='text-3xl font-bold text-headingColor leading-8 mb-6' data-aos="fade-right"
